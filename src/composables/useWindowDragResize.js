/**
 * useWindowDragResize.js
 * Composable for window drag and resize behavior
 * Extracted from FileManagerPanel and Studio components for P0.1
 */
...
export function useWindowDragResize(options = {}) {
  ...
  // Watch visibility to initialize position
